...
import { initializeDatabase, addProject, addReaction, addReply } from './database/projects-db.js';
...
async function migrateData() {
    ...
    for (const project of projects) {
        try {
            // Convert project format to match database schema
            const dbProject = {
                name: project.name,
    ...
    try {
        ...
        console.log(`✅ Database now contains ${allProjects.length} projects`);
