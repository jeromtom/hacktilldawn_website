...
export default function TopProjects() {
  ...
  const ProjectCard = ({ project, index, isTop }) => (
    <motion.div
      ...
      className={`bg-gradient-to-br from-slate-900/90 to-slate-800/90 backdrop-blur-sm border rounded-2xl p-6 hover:border-cyan-500/50 transition-all duration-300 group relative ${
        isTop ? 'border-yellow-500/50 shadow-lg shadow-yellow-500/20' : 'border-slate-700/50'
      }`}
    >
      {/* Top Project Badge */}
      {isTop && (
        <div className="absolute -top-3 -right-3 bg-gradient-to-r from-yellow-500 to-orange-500 text-black text-xs font-bold px-3 py-1 rounded-full shadow-lg">
          #1
        </div>
      )}
    ...
    return (
      <section className="py-24 px-6 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-slate-400">Loading top projects...</p>
        </div>
      </section>
    );
  }
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-slate-400 text-lg max-w-2xl mx-auto">
            Check out the most popular projects based on community reactions and engagement!
          </p>
        </div>
          ...
          <>
            ...
            <div className="text-center">
              <motion.button
                ...
                className="bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white font-semibold py-4 px-8 rounded-lg text-lg transition-all duration-300 shadow-lg hover:shadow-cyan-500/25"
              >
                View All Projects
